...
// Jika connectivityResults adalah List<ConnectivityResult>, kita
...
// kondisi dimana aplikasi mendeteksi bawha tidak ada koneksi sama

    if (connectivityResult == ConnectivityResult.none) {
      Get.offAll(() => const NoConnectionView());
    } else {
// else merupakan kondisi jika aplikasi terhubung dengan koneksi wifi
